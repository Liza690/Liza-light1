    ...
    <section id="about" ref={sectionRef} style={{ background: "var(--white)", padding: "80px 80px", position: "relative", overflow: "hidden" }}>
      ...
      <div className="about-inner" style={{ display: "grid", gridTemplateColumns: "280px 1fr", gap: "64px", alignItems: "center", maxWidth: "1060px", margin: "0 auto", position: "relative", zIndex: 1 }}>
        <div className="about-visual reveal" style={{ position: "relative" }}>
          <img className="model-nobg" src="/images/aboutModel1.webp" alt="LIZA" style={{ width: "100%", height: "360px", objectFit: "cover", objectPosition: "top", borderRadius: "20px", display: "block", boxShadow: "0 16px 50px rgba(124,58,237,0.15)" }} />
          <img className="accent" src="/images/aboutModel2.webp" alt="LIZA" style={{ position: "absolute", bottom: "-16px", right: "-16px", width: "90px", height: "110px", objectFit: "cover", objectPosition: "top", borderRadius: "14px", border: "4px solid var(--white)", zIndex: 3, boxShadow: "0 8px 24px rgba(13,4,6,0.12)" }} />
        </div>
        ...
        <div className="about-text reveal" style={{ display: "flex", flexDirection: "column", justifyContent: "center", position: "relative", zIndex: 2 }}>
          ...
          <p className="about-body" style={{ fontFamily: "'Jost', sans-serif", fontWeight: 400, fontSize: "0.82rem", lineHeight: 1.9, color: "var(--dark)", marginBottom: "28px", maxWidth: "480px", letterSpacing: "0.01em" }}>
            FOUNDED IN 2015, LIZA IS KOLKATA&apos;S MOST DISCREET COMPANIONSHIP AGENCY — CONNECTING DISCERNING GENTLEMEN WITH EXTRAORDINARY WOMEN WHO KNOW HOW TO MAKE EVERY MOMENT FEEL PERSONAL. WE EXIST FOR THOSE WHO CRAVE MORE THAN A TRANSACTION. A CONNECTION THAT LINGERS LONG AFTER SHE&apos;S GONE.
          </p>
